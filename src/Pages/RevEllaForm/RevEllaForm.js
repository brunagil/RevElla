...
import './RevEllaForm.css'

class RevEllaForm extends React.Component {
    constructor() {
      super()       
        this.companyName = '',
        this.city = '',
        ...
        return (
                ...
                <section className='complaint__firstForm'>
                    <div className="container__form" id="complaintForm1">
                        <Form title='O que você gostaria de expor ou denunciar sobre sua empresa?' 
                            ...
                            <Form.Label 
                                htmlFor='city'>Cidade onde aconteceu essa situação na empresa
                                </Form.Label>
                            <Form.Input 
                                id='cityList' 
                                type='text'
                            ...
                            <Form.Label 
                                htmlFor='selectWork'>Qual sua relação atual com essa empresa?
                                </Form.Label>
                            <Form.Select
                                className ='select'
                                listOfOptions = {[
            ...
            <section className='complaint__secondForm'>
                <div className="container__form" id="complaintForm2">
                    ...
                    <Form.Label 
                        htmlFor='selectExp'>Escolha a experiência que você infelizmente viveu/vive?
                    </Form.Label>
                        <Form.Select
                        className='select'
                        listOfOptions={[
                    ...
                    <Form.Label 
                        htmlFor='selectVitim'>Quem foi a mulher que viveu essa experiência?
                    </Form.Label>
                    <Form.Select
                        className='select'
                        listOfOptions={[
                    ...
                    <Form.Label 
                        htmlFor='selectTime'>Quando essa situação aconteceu pela última vez?
                    </Form.Label>
                    <Form.Select
                        className='select'
                        listOfOptions={[
                    ...
                    <Form.Label 
                        htmlFor='selectPlace'>Onde essa situação aconteceu pela última vez?
                    </Form.Label>
                    <Form.Select
                        className='select'
                        listOfOptions={[
                    ...
                    <Form.Label 
                        htmlFor='selectChannel'>A empresa apresenta um departamento, área ou canal de denúncia dessas situações?
                    </Form.Label>
                    <Form.Select
                        className='select'
                        listOfOptions={[
                    ...
                    <Form.Label 
                        htmlFor='testemony'>Se estiver confortável, compartilhe sua história e exponha a situação vivida
                    </Form.Label>
                    <Form.Textarea
                        type='textarea' 
                        id='testemonyAtForm'>
                    ...
                    <Form.Label 
                        htmlFor='selectRespect'>O quão respeitada você, como mulher, se sente nessa empresa?
